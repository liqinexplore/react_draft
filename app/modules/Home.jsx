...
import {DrafEditor} from 'editorPublic';
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div>
                    <h1>draft-js模式二</h1>
                    <DrafEditor active={true} HtmlContent={this.state.markdownContent} cbReceiver={this.receiveMarkdown} uploadConfig={uploadConfig} Image={false} Video={false} Audio={false} ConvertFormat="markdown"/>
                </div>
